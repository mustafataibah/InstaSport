...
class AuthViewModel(
    ...
    enum class AuthenticationState {
        AUTHENTICATED_EMAIL, AUTHENTICATED_GOOGLE, AUTHENTICATED_PHONE, NEW_USER, USER_ALREADY_EXISTS, NEW_USER_GOOGLE, INVALID_EMAIL, WEAK_PASSWORD, INVALID_USER, INVALID_CREDENTIALS, EMAIL_ASSOCIATED_WITH_GOOGLE, FAILED, INVALID_PHONE_CODE, INVALID_PHONE_NUMBER, PHONE_NUMBER_ALREADY_EXISTS, NEW_USER_PHONE, SIGNED_OUT
    }
}
